...
class AuthController extends BaseController {
    ...
    public function login() {
        ...
        // Implementação "Login Inteligente":
        // O sistema busca o usuário pelo login e descobre automaticamente sua clínica.
        ...
        if ($usuario && password_verify($senha, $usuario['senha'])) {
            ...
            // Busca e salva o nome da clínica para personalização da interface
            $nomeClinica = $this->authModel->getClinicaName((int)$usuario['clinica_id']);
            $_SESSION['clinica_nome'] = $nomeClinica ?: 'Prev Dentistas';
